...
OS_LCTL_LSFT = KC.OS(KC.LCTL(OS_LSFT), tap_time=TAP_TIME)
OS_LCTL_LALT = KC.OS(KC.LCTL(OS_LALT), tap_time=TAP_TIME)
OS_LCTL_LGUI = KC.OS(KC.LCTL(OS_LGUI), tap_time=TAP_TIME)
OS_LSFT_LALT = KC.OS(KC.LSFT(OS_LALT), tap_time=TAP_TIME)
OS_LSFT_LGUI = KC.OS(KC.LSFT(OS_LGUI), tap_time=TAP_TIME)
OS_LALT_LGUI = KC.OS(KC.LALT(OS_LGUI), tap_time=TAP_TIME)

OS_LCTL_LSFT_LGUI = KC.OS(KC.LCTL(KC.LSFT(OS_LGUI)), tap_time=TAP_TIME)
OS_LCTL_LSFT_LALT = KC.OS(KC.LCTL(KC.LSFT(OS_LALT)), tap_time=TAP_TIME)
OS_LCTL_LALT_LGUI = KC.OS(KC.LCTL(KC.LALT(OS_LGUI)), tap_time=TAP_TIME)
OS_LSFT_LALT_LGUI = KC.OS(KC.LSFT(KC.LALT(OS_LGUI)), tap_time=TAP_TIME)

OS_LCTL_LSFT_LALT_LGUI = KC.OS(KC.LCTL(KC.LSFT(KC.LALT(OS_LGUI))), tap_time=TAP_TIME)
...
keyboard.keymap = [
    ...
    [
        KC.NO,   DEG,     KC.NO,   KC.NO,   KC.NO,   KC.NO,                       KC.F10,  KC.TILD, KC.NO,   KC.NO,   KC.NO,      KC.NO,
    ...
    [
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.DOWN, KC.UP,   KC.NO,                         KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,    KC.NO,
                                            KC.NO,   KC.TRNS,   KC.NO,     KC.NO,   KC.NO, KC.NO
    ]
]
